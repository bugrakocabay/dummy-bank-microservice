...
// Source: github.com/bugrakocabay/dummy-bank-microservice/account-service/db/sqlc (interfaces: Store)
...
func (m *MockStore) GetAccountBalance(arg0 context.Context, arg1 string) (db.GetAccountBalanceRow, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransaction(arg0 context.Context, arg1 string) (db.Transaction, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListTransactions(arg0 context.Context) ([]db.Transaction, error) {
	m.ctrl.T.Helper()
